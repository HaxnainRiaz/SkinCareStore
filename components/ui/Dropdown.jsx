    ...
    return (
        <div className={cn("relative w-full", className)} ref={dropdownRef}>
            ...
            <button
                ...
                className={cn(
                    "w-full flex items-center justify-between px-5 py-3 bg-white border border-[#F5F3F0] rounded-2xl text-sm font-medium transition-all duration-300 shadow-sm hover:shadow-md h-[54px]",
            ...
            >
                {Icon && (
                    <div className="absolute left-5 top-1/2 -translate-y-1/2 text-[#B8A68A]">
                        <Icon size={18} />
                    </div>
                )}
