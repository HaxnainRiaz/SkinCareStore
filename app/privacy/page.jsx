...
export const metadata = {
    title: 'Privacy Policy - Luminelle',
};
        ...
        <div className="min-h-screen bg-[#FDFCFB]">
            ...
            <Container className="py-16">
                <div className="max-w-4xl mx-auto">
                    ...
                    <h2 className="text-2xl font-heading font-bold text-[#0a4019] mt-8 mb-4">Information We Collect</h2>
                    ...
                    <h2 className="text-2xl font-heading font-bold text-[#0a4019] mt-8 mb-4">How We Use Your Information</h2>
                    <p className="text-[#6B6B6B] mb-4">We use the information we collect to:</p>
                    <ul className="list-disc list-inside text-[#6B6B6B] mb-6 space-y-2">
                    ...
                    <h2 className="text-2xl font-heading font-bold text-[#0a4019] mt-8 mb-4">Information Sharing</h2>
                    <p className="text-[#6B6B6B] mb-6">
                    ...
                    <h2 className="text-2xl font-heading font-bold text-[#0a4019] mt-8 mb-4">Data Security</h2>
                    <p className="text-[#6B6B6B] mb-6">
                        We implement appropriate security measures to protect your personal information. However, no method of transmission over the Internet is 100% secure.
                    </p>

                    <h2 className="text-2xl font-heading font-bold text-[#0a4019] mt-8 mb-4">Your Rights</h2>
                    <p className="text-[#6B6B6B] mb-6">
                    ...
                    <h2 className="text-2xl font-heading font-bold text-[#0a4019] mt-8 mb-4">Contact Us</h2>
