        ...
        <div className="min-h-screen bg-neutral-cream">
            ...
            <Container className="py-16">
                <div className="max-w-4xl mx-auto prose prose-lg">
                    ...
                    <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">4. Pricing</h2>
                    <p className="text-neutral-gray mb-6">
                    ...
                    <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">5. Account Terms</h2>
                    <p className="text-neutral-gray mb-6">
                        You are responsible for maintaining the confidentiality of your account and password. You agree to accept responsibility for all activities that occur under your account.
                    </p>

                    <h2 className="text-2xl font-heading font-bold text-primary mt-8 mb-4">6. Prohibited Uses</h2>
                    <p className="text-neutral-gray mb-6">
